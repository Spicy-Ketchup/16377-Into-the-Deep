...
public class Sample_RightSideAutoPath extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        TrajectoryActionBuilder specimen_5_park = drive.actionBuilder(initialPose)
                .afterTime(0, (p) -> {ALiftTarget.set(245); return false;})
                .afterDisp(5,(p) -> {
                ...
                .splineToConstantHeading(new Vector2d(49,38), Math.toRadians(65))
                ...
                .afterTime(0, (p) -> {
                    ...
                    servos.wrist.setPosition(.25);
                return false;})
                .strafeToConstantHeading(new Vector2d(9.8, 26.7),drive.customVelConstraint6, drive.customAccelConstraint2)
                .stopAndAdd((p) -> {
                ...
                .afterTime(.25, (p) -> {
                    ...
                    servos.wrist.setPosition(.25);
                    return false;})
                .afterTime(1.7, (p) -> {ALiftTarget.set(245); return false;})
                .waitSeconds(.85)
                ...
                .waitSeconds(0.1)
                .strafeToConstantHeading(new Vector2d(9.4,55.2), drive.customVelConstraint5)
                .waitSeconds(.25)
                .stopAndAdd((p) -> {
                    servos.claw.setPosition(.42);
                    return false;})
                ...
                .waitSeconds(.15)
                .strafeToConstantHeading(new Vector2d(9.8,55.2), drive.customVelConstraint5)
                .waitSeconds(.25)
                .stopAndAdd((p) -> {
                    servos.claw.setPosition(.42);
                    return false;})
